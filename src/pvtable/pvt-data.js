export const pvtdata = {
  "labels": [
      {
          "col": "data_registo",
          "label": "Parcelas-Data de registo"
      },
      {
          "col": "area_registo",
          "label": "Parcelas-Área declarada (ha)"
      },
      {
          "col": "num_proprietarios",
          "label": "Parcelas-Nº de proprietários"
      },
      {
          "col": "especie_principal",
          "label": "Parcelas-Espécie principal"
      },
      {
          "col": "parametro1",
          "label": "Amostra de solos-Parâmetro 1 (%)"
      },
      {
          "col": "hora",
          "label": "Amostra de solos-Hora"
      },
      {
          "col": "data",
          "label": "Amostra de solos-Data"
      },
      {
          "col": "numerico2",
          "label": "Teste tipo de dados-Nomérico double"
      },
      {
          "col": "booleano",
          "label": "Teste tipo de dados-Valor booleano"
      },
      {
          "col": "inteiro",
          "label": "Teste tipo de dados-Valor inteiro"
      },
      {
          "col": "descricao",
          "label": "Teste tipo de dados-Descrição"
      },
      {
          "col": "hora_",
          "label": "Teste tipo de dados-Hora"
      },
      {
          "col": "data_",
          "label": "Teste tipo de dados-Data"
      },
      {
          "col": "identificacao",
          "label": "Castas de vinha-Identificação"
      },
      {
          "col": "_area_inter",
          "label": "Parcelas-Área de intersecção"
      }
  ],
  "data": [
      [
...
export const demoPvtData = [
  ["row-mais texto","total_bill com muito texto para experimentar","tip - gorjeta em português de PT","sex - Masculino ou feminino","smoker - será que fuma?","day do evento","time","size - tamanho"],
